...
for ticket_id in range(1, 1000001):
    ...
    mydb._execute_query("INSERT INTO ticket_line (ticket_number) VALUES ()")
    ...
    for number in numbers:
        mydb._execute_query("INSERT INTO ticket_line_numbers (number, ticket_line_id) VALUES (?, ?)", (number, ticket_line_id))
